          ...
          <v-col cols="6">
            <v-card light class="face-card">
              <div class="image-wrap">
                <v-img
                  :src="require('@/../../../storage/image/faceimages/nface_image/face_image/99.jpeg')"
                />
                <v-btn
                  class="image-icon"
                  elevation="5"
            ...
            <v-card light class="my-card ml-auto">
              <div class="rank-wrap">
                ...
                <v-img
                  ...
                  :src="require('@/../../../storage/image/faceimages/rank/gold.png')"
                  class="rank-icon"
                  contain
                />
                <v-img
                  v-else-if="rank > 50 && score === 'B'"
                  :src="require('@/../../../storage/image/faceimages/rank/silver.png')"
                  class="rank-icon"
                  contain
                />
                <v-img
                  v-else-if="score !== 'C'"
                  src="require('@/assets/rank/blond.png')"
                  class="rank-icon"
                  contain
                />
                <v-img
                  v-else
                  src="require('@/assets/rank/nomal.png')"
                  class="rank-icon"
                  contain
                />
              </div>
