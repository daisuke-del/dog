...
export default {
    ...
    data () {
        return {
            displayImage: `https://www.dogiland.jp/storage/image/dogimages/${this.dogInfo.dog_image1}`
        }
    },
    computed: {
        dogImage1 () {
            return this.dogInfo.dog_image1 && `https://www.dogiland.jp/storage/image/dogimages/${this.dogInfo.dog_image1}`
        },
        dogImage2 () {
            return this.dogInfo.dog_image2 && `https://www.dogiland.jp/storage/image/dogimages/${this.dogInfo.dog_image2}`
        },
        dogImage3 () {
            return this.dogInfo.dog_image3 && `https://www.dogiland.jp/storage/image/dogimages/${this.dogInfo.dog_image3}`
        },
        dogAge () {
    ...
    watch: {
        dogInfo: {
            handler () {
                this.displayImage = `https://www.dogiland.jp/storage/image/dogimages/${this.dogInfo.dog_image1}`
            },
            deep: true,
        }
    }
